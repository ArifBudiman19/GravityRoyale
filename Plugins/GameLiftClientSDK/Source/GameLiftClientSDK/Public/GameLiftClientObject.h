...
private:
	...
	void Internal_InitGameLiftClientSDK(const FGameLiftClientConfiguration& ClientConfig, const FGameLiftCredentials& Credentials, bool bUsingGameLiftLocal, int32 LocalPort);
...
public:
	...
	**/
	UFUNCTION(BlueprintCallable, Category = "GameLift Client Object")
		static UGameLiftClientObject* CreateGameLiftObject(const FGameLiftClientConfiguration& ClientConfig, const FGameLiftCredentials& Credentials, bool bUsingGameLiftLocal = false, int32 LocalPort = 9080);
	...
	**/
	UFUNCTION(BlueprintCallable, Category = "GameLift Client Object")
	UGameLiftCreatePlayerSession* CreatePlayerSession(FString GameSessionID, FString UniquePlayerID, FString PlayerData);
