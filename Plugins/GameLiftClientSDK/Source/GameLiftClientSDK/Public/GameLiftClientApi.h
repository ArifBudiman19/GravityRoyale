...
UCLASS()
class GAMELIFTCLIENTSDK_API UGameLiftHelper : public UObject
{
	GENERATED_BODY()

public:
	static FDateTime ConvertGameLiftTime(const Aws::Utils::DateTime Time);

	static FGameLiftGameSession CastToGameSession(Aws::GameLift::Model::GameSession* GameSession);

	static EGameLiftPlayerSessionCreationPolicy CastToPlayerSessionPolicy(Aws::GameLift::Model::PlayerSessionCreationPolicy Policy);

	static EGameLiftGameSessionStatus CastToGameSessionStatus(Aws::GameLift::Model::GameSessionStatus Status);

	static EGameLiftGameSessionStatusReason CastToGameSessionStatusReason(Aws::GameLift::Model::GameSessionStatusReason Reason);
};
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnDescribeGameSessionDetailsStateSuccess, const FGameLiftGameSession&, GameSession, EGameLiftGameSessionStatus, SessionState);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnDescribeGameSessionDetailsStateFailed, const FString&, ErrorMessage);
UCLASS()
...
public:
	...
	UPROPERTY(BlueprintAssignable, Category = "GameLift DescribeGameSession")
		FOnDescribeGameSessionDetailsStateSuccess OnDescribeGameSessionStateSuccess;

	UPROPERTY(BlueprintAssignable, Category = "GameLift DescribeGameSession")
		FOnDescribeGameSessionDetailsStateFailed OnDescribeGameSessionStateFailed;
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnCreatePlayerSessionSuccess, const FGameLiftPlayerSession&, PlayerSession, const int&, PlayerSessionStatus);
...
private:
	...
	static UGameLiftCreatePlayerSession* CreatePlayerSession(FString GameSessionID, FString UniquePlayerID, FString PlayerData);
